...
module.exports = class BrandsDBApi {
  ...
  static async findBy(where, options) {
    ...
    const brands = await db.brands.findOne({ where }, { transaction });
  ...
  static async findAll(filter, options) {
    ...
    if (filter) {
      ...
      if (filter.name) {
        where = {
          ...where,
          [Op.and]: Utils.ilike('brands', 'name', filter.name),
        };
      }
      ...
      if (filter.description) {
        where = {
          ...where,
          [Op.and]: Utils.ilike('brands', 'description', filter.description),
        };
      }
    ...
    let { rows, count } = options?.countOnly
      ...
      : await db.brands.findAndCountAll({
          where,
          include,
          distinct: true,
          limit: limit ? Number(limit) : undefined,

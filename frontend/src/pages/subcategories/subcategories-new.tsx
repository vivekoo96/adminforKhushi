...
import { create } from '../../stores/subcategories/subcategoriesSlice';
...
SubcategoriesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_SUBCATEGORIES'}>
      {page}
    </LayoutAuthenticated>
  );
};

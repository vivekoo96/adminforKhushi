...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/categories/categoriesSlice';
...
const TableSampleCategories = ({
  ...
  useEffect(() => {
    if (categoriesNotify.showNotification) {
      notify(
        categoriesNotify.typeNotification,
        categoriesNotify.textNotification,
      );
    }

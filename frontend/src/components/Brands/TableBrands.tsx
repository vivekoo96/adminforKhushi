...
import {
  ...
  deleteItem,
  setRefetch,
} from '../../stores/brands/brandsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureBrandsCols';
...
const TableSampleBrands = ({
  ...
  useEffect(() => {
    if (brandsNotify.showNotification) {
      notify(brandsNotify.typeNotification, brandsNotify.textNotification);
    }
  }, [brandsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/brands/brands-view/?id=${id}`);
  };
...
export default TableSampleBrands;
